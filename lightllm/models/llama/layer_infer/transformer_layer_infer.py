...
class LlamaTransformerLayerInfer(TransformerLayerInferTpl):
    ...
    def __init__(self, layer_num, tp_rank, world_size, network_config, mode=[]):
        ...
        self.compiled_get_qkv = self.real_get_qkv #torch.compile(self.real_get_qkv, backend='ascendgraph', dynamic=False)
        self.compiled_get_o  = self.real_get_o #torch.compile(self.real_get_o, backend='ascendgraph', dynamic=False)
        self.compiled_ffn = self.real_ffn #torch.compile(self.real_ffn, backend='ascendgraph', dynamic=False)
        return
