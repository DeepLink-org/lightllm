...
class LlamaPostLayerInfer(PostLayerInferTpl):
    ...
    def __init__(self, tp_rank, world_size, network_config, mode):
        ...
        self.opt_token_forward = torch.compile(self.token_forward, backend='ascendgraph', dynamic=False)
        self.opt_dicp_token_forward = torch.compile(self.dicp_token_forward, backend='ascendgraph', dynamic=False)
